...
def isomdl_mdoc_sign(
    ...
    try:
        ...
        # issuer_signed_b64() serializes IssuerSigned with ISO 18013-5 §8.3
        # compliant camelCase keys (issuerAuth, nameSpaces) and returns a
        # base64url-encoded CBOR byte string. This replaces the old
        # stringify() + _patch_mdoc_keys() workaround.
