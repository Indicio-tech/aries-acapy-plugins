...
from ..mdoc.verifier import (FileTrustStore, MsoMdocCredVerifier,  # noqa: E402
                             MsoMdocPresVerifier, VerifyResult)
...
class TestMsoMdocPresVerifier:
    ...
    async def test_verify_presentation_success(self, verifier, mock_presentation):
        ...
        with patch("mso_mdoc.mdoc.verifier.isomdl_uniffi") as mock_isomdl, \
             patch("mso_mdoc.mdoc.verifier.OID4VPPresDef") as mock_pres_def_cls, \
             patch("mso_mdoc.mdoc.verifier.PresentationDefinition") as mock_pd_cls:
            ...
            mock_isomdl.DeviceResponse.from_cbor_encoded_device_response.return_value = mock_device_response
            ...
            mock_isomdl.verified_response_as_json_string.return_value = '{"data": "verified"}'
    
            result = await verifier.verify_presentation(profile, presentation_data, mock_presentation)
            ...
            mock_isomdl.verified_response_as_json_string.assert_called_once_with(mock_response_data)
