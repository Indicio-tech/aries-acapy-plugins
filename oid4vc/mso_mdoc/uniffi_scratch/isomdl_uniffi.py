...
class ItemsRequest:
    ...
    def __str__(self):
        return "ItemsRequest(doc_type={}, namespaces={})".format(self.doc_type, self.namespaces)
...
class MdlReaderResponseData:
    ...
    def __init__(self, *, state: "MdlSessionManager", verified_response: "dict[str, dict[str, MDocItem]]", issuer_authentication: "AuthenticationStatus", device_authentication: "AuthenticationStatus", errors: "typing.Optional[str]"):
        self.state = state
    ...
    def __str__(self):
        return "MdlReaderResponseData(state={}, verified_response={}, issuer_authentication={}, device_authentication={}, errors={})".format(self.state, self.verified_response, self.issuer_authentication, self.device_authentication, self.errors)
...
class MdlReaderSessionData:
    ...
    request: "bytes"
    ble_ident: "bytes"
    def __init__(self, *, state: "MdlSessionManager", uuid: "Uuid", request: "bytes", ble_ident: "bytes"):
        self.state = state
        self.uuid = uuid
    ...
    def __str__(self):
        return "MdlReaderSessionData(state={}, uuid={}, request={}, ble_ident={})".format(self.state, self.uuid, self.request, self.ble_ident)
...
MDocItem.TEXT = type("MDocItem.TEXT", (MDocItem.TEXT, MDocItem,), {})  # type: ignore
MDocItem.BOOL = type("MDocItem.BOOL", (MDocItem.BOOL, MDocItem,), {})  # type: ignore
MDocItem.INTEGER = type("MDocItem.INTEGER", (MDocItem.INTEGER, MDocItem,), {})  # type: ignore
MDocItem.ITEM_MAP = type("MDocItem.ITEM_MAP", (MDocItem.ITEM_MAP, MDocItem,), {})  # type: ignore
MDocItem.ARRAY = type("MDocItem.ARRAY", (MDocItem.ARRAY, MDocItem,), {})  # type: ignore
...
class MdlReaderResponseError:  # type: ignore
    ...
    class InvalidIssuerAuthentication(_UniffiTempMdlReaderResponseError):
        ...
        def __repr__(self):
            return "MdlReaderResponseError.InvalidIssuerAuthentication({})".format(str(self))
    ...
    class InvalidDeviceAuthentication(_UniffiTempMdlReaderResponseError):
        ...
        def __repr__(self):
            return "MdlReaderResponseError.InvalidDeviceAuthentication({})".format(str(self))
...
class _UniffiConverterSequenceTypeItemsRequest(_UniffiConverterRustBuffer):
    ...
    def read(cls, buf):
        ...
        return [
            _UniffiConverterTypeItemsRequest.read(buf) for i in range(count)
        ]
...
class _UniffiConverterSequenceTypeMDocItem(_UniffiConverterRustBuffer):
    ...
    def read(cls, buf):
        ...
        return [
            _UniffiConverterTypeMDocItem.read(buf) for i in range(count)
        ]
...
def establish_session(uri: "str",requested_items: "dict[str, dict[str, bool]]",trust_anchor_registry: "typing.Optional[typing.List[str]]") -> "MdlReaderSessionData":
