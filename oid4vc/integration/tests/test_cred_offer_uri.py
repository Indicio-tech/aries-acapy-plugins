...
@pytest.mark.asyncio
async def test_credential_offer_structure(acapy_issuer_admin, issuer_did, supported_cred_id):
...
@pytest.mark.asyncio
async def test_credential_offer_by_ref_structure(acapy_issuer_admin, issuer_did, supported_cred_id):
    ...
    assert offer_response["credential_offer_uri"].startswith("openid-credential-offer://")
    ...
    async with ClientSession() as session:
        async with session.get(offer_ref_url) as resp:
            ...
            assert dereferenced_offer["credential_offer"].startswith("openid-credential-offer://")
