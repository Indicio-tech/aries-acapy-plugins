...
public_routes.py module. For now, to avoid circular imports, the register
function is imported using sys.modules manipulation.
"""
...
def __getattr__(name):
    ...
    if name == "register":
        ...
        # We need to get the .py module which Python loaded as part of
        # oid4vc. When Python imported oid4vc, it loaded public_routes.py
        # first before this package. But then it replaced
        # sys.modules['oid4vc.public_routes'] with this package.
